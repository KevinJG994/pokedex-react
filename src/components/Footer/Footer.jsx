...
export default function Footer() {
    return (
        <footer className="footer sm:footer-horizontal bg-(--red-primary) text-gray-50 items-center p-4">
            <aside className="grid-flow-col items-center">
                ...
                <p>Copyright © {new Date().getFullYear()} - All right and left reserved </p>
            </aside>
